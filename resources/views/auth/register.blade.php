        ...
        <div class="w-4/12 bg-white p-6 m-2 rounded-lg">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="enter your password again" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('password_confirmation') border-red-500 @enderror" value="">
